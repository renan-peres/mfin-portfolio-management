...
#### Investment Summary {width=70%}

```{ojs}
html`
  <div>
      <h5 class="table-title" style="margin-bottom: 0;">Investment Summary</h5>
      <table class="table table-sm mb-0">
        <tbody>
          <tr><th scope="row" style="width: 30%;">Initial Investment:</th><td>${formatCurrency(investment_amount)}</td></tr>
...
:::: {.columns style="height: calc(100vh - 750px); width: 100%;"}
