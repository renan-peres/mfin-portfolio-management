...
capitalAllocationPlot = Plot.plot({
  ...
  marks: [
    ...
    Plot.text([
      ...
      {x: 0.005, y: rf_rate, text: "Risk-Free Asset", dx: 10, dy: -30}
    ], {
      x: "x",
      y: "y",
      text: "text",
...
html`
  <div>
    <h5 class="table-title" style="margin-top: 0em; margin-bottom: 0em;">Optimal Capital Allocation</h5>
...
Plot.plot({
  ...
  marks: [
    ...
    Plot.text([{
      ...
      y: "y",
      text: "text",
      dx: -75,          // Horizontal offset from point
      dy: -15,         // Vertical offset from point
      fontWeight: "bold",
      fontSize: 12,
      textAnchor: "start" // Align text to start from the point
    })
  ]
})
```
