...
EFFICIENT_FRONTIER = `${RAW_URL}/efficient_frontier-2025-04-26.html`
```
...
bond_tk        = [bond_pf["Price Change Sensitivity (Expected Return)"].idxmax()]  # highest Px‑chg‑sens.
...
bond_ret = bond_pf.loc[bond_tk[0], "Price Change Sensitivity (Expected Return)"]  # ‹assumption›
