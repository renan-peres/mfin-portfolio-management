...
viewof capitalAllocationDisplay = {
  ...
  // Create container with plot and legend
  const container = html`<div style="position: relative;">
    <h5 class="table-title" style="margin-top: 0em; margin-bottom: 1em;">Capital Allocation Line with Indifference Curve</h5>
...
html`
  <div>
    <h5 class="table-title" style="margin-top: 0em; margin-bottom: 0em;">Capital Allocation (Optimal Portfolio)</h5>
...
viewof utilityWeightChart = {
  ...
  // Return the container with both header and plot
  return html`
    <div>
      <h5 class="table-title" style="margin-top: 0em; margin-bottom: 1em;">Utility vs. Risky Portfolio Weight</h5>
      ${plot}
    </div>
  `;
}
