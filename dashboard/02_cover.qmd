...
::: {.callout-tip}
**Responsive <a href="#" class="sidebar-hover-trigger">sidebar<span class="hover-image"><img src="img/sidebar.png" alt="sidebar"></span></a> inputs (located on the left side of the screen)** — adjust the values and every calculation, charts, and tables will be updated accordingly.
:::
...
<h3 class="table-title" style="margin-top: 12px;">Security Selection Process</h3>
