...
::: {.callout-tip}
**Interactive <a href="#" class="sidebar-hover-trigger">sidebar<span class="hover-image"><img src="img/sidebar.png" alt="sidebar"></span></a> inputs (on the left side of the screen)** — adjust the values and every chart, table, and analysis will be updated automatically.
:::
...
<div class="portfolio-showcase">
  ...
  <tr>
    <td align="center"><a href="#security-allocation" style="text-decoration: none;"><strong>Security Efficient Frontier</strong></a></td>
...
<div class="table-responsive">
  <h3 class="table-title" style="margin-top: 4px;">Contents</h3>
