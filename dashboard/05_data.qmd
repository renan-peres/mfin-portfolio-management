...
## Bond Valuation (Highlight TLT)

```{python}
bond_valuation = bond_pf.copy() 
bond_valuation = bond_valuation.drop(["Sharpe_Ratio"], axis=1)
bond_valuation = bond_valuation.sort_values(by="Price Change Sensitivity (Expected Return)", ascending=False)

# Transform Data Types
pct_cols = ['Yield_To_Maturity', 'Weighted_Avg_Coupon', 'Price Change Sensitivity (Expected Return)', 'Standard_Deviation']
...
# Order Columns
# Fixed: Ensure column name consistency
desired_order = ['Ticker', 'Name',  'Perf. as of', 'Inception Date', 'Price Change Sensitivity (Expected Return)', "Standard_Deviation", "Duration (D*)", "Convexity", "Weighted_Avg_Maturity", "Weighted_Avg_Coupon", "Yield_To_Maturity"]
